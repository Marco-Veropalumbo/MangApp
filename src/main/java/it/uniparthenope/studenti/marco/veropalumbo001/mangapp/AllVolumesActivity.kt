...
class AllVolumesActivity: AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_allvolumes)
        ...
        viewModel.getAllVolumes(prefQuartiere)
        viewModel.myResponseAllVolume.observe(this, Observer { response ->
    ...
    private fun setupRecyclerview(){
        val recyclerView = findViewById<RecyclerView>(R.id.allVolumes)
